...
/**
 * Clients Logos Pause on Hover
 */
const wrapper = document.querySelector('.logos-wrapper');

wrapper.addEventListener('mouseover', () => {
  wrapper.style.animationPlayState = 'paused'; /* Pause animation */
});

wrapper.addEventListener('mouseout', () => {
  wrapper.style.animationPlayState = 'running'; /* Resume animation */
});


/**
 * For Smooth Transitions and Paginators
 */
// Select testimonials and dots
